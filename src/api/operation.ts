...
const add = async (requestData: IAddOrEditOperationRequest) => {
  return await defaultRequest.post<IGetAllResponse<any>>(`api/jwt/CodiumSystem/Operation/Add`, {
    kv: requestData,
  });
};
...
const addHtmlForm = async (requestData: IAddHtmlFormRequest) => {
  return await defaultRequest.post<IGetAllResponse<any>>(`api/jwt/CodiumSystem/Operation/OperationHtmlForm`, {
    kv: requestData,
  });
};

const addViewForm = async (requestData: IAddViewFormRequest) => {
  return await defaultRequest.post<IGetAllResponse<any>>(`api/jwt/CodiumSystem/Operation/OperationViewForm`, {
    kv: requestData,
  });
};

const getHtmlFormOrViewname = async (requestData: IGetHtmlFormOrViewnameRequest) => {
  return await defaultRequest.post<IGetAllResponse<any>>(`api/jwt/CodiumSystem/Operation/GetHtmlFormOrViewname`, {
    kv: requestData,
  });
};
