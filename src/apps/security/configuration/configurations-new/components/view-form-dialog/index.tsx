...
export const ViewFormDialog = () => {
  ...
  const opened = useSelector((state: AppState) => state.configurationsNew.viewFormDialogOpened);
  const selectedOperation = useSelector((state: AppState) => state.configurationsNew.selectedOperationViewForm);
